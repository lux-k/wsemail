...
namespace P3P
{
	...
	public class RECIPIENT
	{
		...
		public bool equals( RECIPIENT compareTo)
		{
			...
			if ( compareTo.m_delivery != this.m_delivery )
			{
				same = false;
			}
			if ( compareTo.m_other_recipient!= this.m_other_recipient )
			{
				same = false;
			}
			...
			if ( compareTo.m_public != this.m_public )
			{
				same = false;
			}			
			if ( compareTo.m_same != this.m_same )
			{
				same = false;
			}
			if ( compareTo.m_unrelated != this.m_unrelated )
			{
				same = false;
			}
