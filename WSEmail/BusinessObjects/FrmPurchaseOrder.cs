	...
	public class FrmPurchaseOrder : System.Windows.Forms.Form, BusinessObjectsFormInterface
	{
		...
		private void InitializeObjects() 
		{
			...
			if (b != null && b.BusinessObject != null) 
			{
				...
				string myID = PennRoutingFilters.PennRoutingUtilities.GetCertEmail(PennRoutingFilters.PennRoutingUtilities.GetSecurityToken(ConfigurationSettings.AppSettings["SigningCertificate"],false).Certificate);
...
//String.Format("c{0}",p.Total.ToString());
		...
		public void LoadBusinessRequestAndShow(BusinessRequest b) 
		{
			this.b = b;
			if (b != null)
				p = (PurchaseOrder)b.BusinessObject;
		...
		private void btnSubmit_Click(object sender, System.EventArgs e)
		{
			...
			if (b.BusinessObject == null) {
				p.FormName = FORMNAME;
				b.Approvals.Required.Add(new Signature("POs@AutomatedServer",null));
				b.Approvals.Required.Add(new Signature("Purchasing@MailServerA",null));
				b.Mappings.Add(new MappedItem("Claimant",null,null));
				b.Mappings.Add(new MappedItem("Purchasing","Purchasing@MailServerA",null));
			}
