...
//			this.txtUser.Text = "kevin";
		...
		private void InitializeComponent()
		{
			...
			this.tabControl1.Size = new System.Drawing.Size(384, 232);
			...
			// btnUserPassOK
			// 
			this.btnUserPassOK.Location = new System.Drawing.Point(280, 152);
			...
			// txtUser
			// 
			this.txtUser.Location = new System.Drawing.Point(120, 24);
			...
			// btnCertOK
			// 
			this.btnCertOK.Location = new System.Drawing.Point(280, 152);
		...
		private void cmbStore_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			...
			foreach (X509Certificate c in store.Certificates) 
				cmbCert.Items.Add(Utilities.GetCertCN(c));
		...
		private void btnCertOK_Click(object sender, System.EventArgs e)
		{
			...
			{
				this.SecurityToken = new X509SecurityToken(Utilities.GetSecurityToken((string)cmbCert.SelectedItem,machinestore).Certificate);
				Done();
			}
		}
