...
namespace WSEMailClient
{
	...
	/// </summary>
	public class newfrmSend : System.Windows.Forms.Form
	{
		...
		public delegate WSEmailStatus sendMessageDelegate(newWSEmailMessage m, XmlElement sig);
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(newfrmSend));
		...
		/// </summary>
		/// 
		private newWSEmailMessage theMessage = null;
		public void reply(newWSEmailMessage w) 
		{
			theMessage = w;
			UpdateFormStatus();
		}			
...
//					txtRecipient.Text = theMessage.Sender;
		...
		private void btnSend_Click(object sender, System.EventArgs e)
		{
			...
			newWSEmailMessage wem = new newWSEmailMessage();
...
//			}
			...
			sendMessageDelegate AsyncDelegate = new sendMessageDelegate(m.newWSEmailSend);
			...
			m.BeginnewWSEmailSend(wem,null,callback,null);
...
*/
		...
		{
			if (theMessage == null)
				theMessage = new newWSEmailMessage();
...
*/					
			...
			ObjectConfiguration oc = new ObjectConfiguration();
			oc.DLL = "BabyObjects";
			oc.Name = "BabyObjects.BabyObject";
			BO = ObjectLoader.LoadObject(oc);
			BO.DoneRunning += new BaseObject.BaseObjectDelegate(FormDone);
			BO.Run();
...
//			frmForm.LoadBusinessRequestAndShow(null);
		...
		{
			MessageBox.Show(b.DebugToScreen());
