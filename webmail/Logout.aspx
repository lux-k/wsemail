...
-->
<%@ Page language="c#" Codebehind="Default.aspx.cs" AutoEventWireup="false" Inherits="webmail.Logout" %>
...
<table width=100%><tr><td align=right><img src="logo-non.gif" width="480" height="57"><i><h2>WSEmail Project<br><br><center>WSEmail Web Access</center>
    ...
    <td bgcolor=ffff99 align=center><br>
      <!-- InstanceBeginEditable name="Content" --> You have now logged out of 
					WSEmail Web Access.<br> <!-- InstanceEndEditable --><br></td>
  </tr>
	  </table>
